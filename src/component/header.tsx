                ...
                <div className='relative flex justify-start items-center gap-6'>
                    ...
                    <div className='flex w-[40px] h-[40px] justify-center items-center cursor-pointer rounded-full bg-fifty' onClick={handleShowMore}>
                        <div className='flex justify-center items-center flex-col w-2/3'>
                            <span className='bg-secondary rounded-[10px] h-[4px] my-[2px] mx-0 w-1/2'></span>
                            <span className='bg-secondary rounded-[10px] h-[4px] my-[2px] mx-0 w-full'></span>
                            <span className='bg-secondary rounded-[10px] h-[4px] my-[2px] mx-0 w-2/3'></span>
                        </div>
                    </div>
                </div>
            </div>
