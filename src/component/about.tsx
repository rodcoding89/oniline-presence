                            ...
                            <div className='flex flex-col gap-y-4 ml-4'>
                            {
                                pathway.map((item,index)=>{
                                    return (
                                        <>
                                    {
                                        index === 2 && <div key={"image"+index} className='flex justify-center items-center w-full my-4'><img className='w-1/3 h-auto max-792:w-2/3' src="/assets/images/about.svg" alt="about" /></div>
                                    }
                                        <div key={index}
                                        >
