...
const Footer:React.FC<FooterProps> = ()=>{
    return (
        <footer className='bg-primary w-full flex justify-start items-center gap-8 flex-col py-10 mt-10 px-[8%] '>
            ...
            <div className='flex justify-between items-start gap-7 w-full max-640:flex-col'>
                ...
                <div className='w-4/3 flex justify-end items-end max-640:w-full max-640:justify-start max-640:items-start'>
            ...
            <div className='w-full flex justify-between items-center gap-4 max-520:flex-col max-520:justify-center max-520:items-center max-520:w-full'>
                <Link to={'/fr/legal-notice'} className='text-fifty underline hover:text-link'>Mentions légales</Link>
                <p className='text-fifty flex-1 text-right max-520:text-center'>© Copyright {new Date().getFullYear()} Tous droits réservés.</p>
            </div>
        </footer>
    )
}
