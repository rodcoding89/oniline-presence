...
import { priceList,maintenanceOption } from '../utils/constant';
                                ...
                                return (
                                    <>
                                    {
                                        !Array.isArray(item.bloc) ? (
                                            ...
                                            <div className='flex flex-col justify-between items-center gap-3 basis-[200px] flex-grow max-w-[400px]'>
                                                {
